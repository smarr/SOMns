...
then
  declare -a Savina=(
    ...
    #"ConcurrentDictionary 1 0 5:100:5" chicken egg problem with entry class
  ...
  declare -a Savina=(
    ...
    #"BankTransaction 1 0 1000:100000" chicken egg
    #"RadixSort 1 0 50000:65536:74755" #not reliable
    #"UnbalancedCobwebbedTree 1 0 100000:10:500:100" #some kind of memory leak or infinite deserialization...
    "TrapezoidalApproximation 1 0 100:1000000:1:5"
    #"AStarSearch 1 0 100:20" #same issue as unblanced
    "NQueens 1 0 20:10:4"
  )
fi
