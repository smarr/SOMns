...
public abstract class TernaryPolymorphicMessageNode extends TernaryMessageNode {
  ...
  public TernaryPolymorphicMessageNode(final SSymbol selector,
  ...
  public TernaryPolymorphicMessageNode(final TernaryPolymorphicMessageNode node) {
  ...
  @Override
  @Specialization
  public Object doGeneric(final VirtualFrame frame, final Object rcvr, final Object firstArg, final Object secondArg) {
    ...
    for (i = 0; i < cacheEntries; i++) {
      if (rcvrClasses[i] == currentRcvrClass) {
        return invokables[i].invoke(frame.pack(), receiver, new SAbstractObject[] {(SAbstractObject) firstArg, (SAbstractObject) secondArg});
      }
    }
    ...
    if (i < CACHE_SIZE) { // we got still room in this polymorphic inline cache
      ...
      cacheEntries++;
      return invkbl.invoke(frame.pack(), receiver, new SAbstractObject[] {(SAbstractObject) firstArg, (SAbstractObject) secondArg});
    } else {
