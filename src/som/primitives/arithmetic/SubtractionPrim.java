...
public abstract class SubtractionPrim extends ArithmeticPrim {
  public SubtractionPrim(final SSymbol selector, final Universe universe, final SClass rcvrClass, final SMethod invokable) { super(selector, universe, rcvrClass, invokable); }
  public SubtractionPrim(final SubtractionPrim node) { this(node.selector, node.universe, node.rcvrClass, node.invokable); }
