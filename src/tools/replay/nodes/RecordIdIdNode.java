...
public abstract class RecordIdIdNode extends Node {
  ...
  public int traceByteId(final UniformTraceBuffer storage, final int idx, final int id1,
      final int id2) {
  ...
  public int traceShortId(final UniformTraceBuffer storage, final int idx, final int id1,
      final int id2) {
  ...
  public int traceThreeByteId(final UniformTraceBuffer storage, final int idx, final int id1,
      final int id2) {
  ...
  public int traceStandardId(final UniformTraceBuffer storage, final int idx, final int id1,
      final int id2) {
