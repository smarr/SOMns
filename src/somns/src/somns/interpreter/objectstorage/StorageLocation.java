package somns.interpreter.objectstorage;
...
import somns.interpreter.nodes.dispatch.CachedSlotRead.DoubleSlotReadSet;
import somns.interpreter.nodes.dispatch.CachedSlotRead.DoubleSlotReadSetOrUnset;
import somns.interpreter.nodes.dispatch.CachedSlotRead.LongSlotReadSet;
import somns.interpreter.nodes.dispatch.CachedSlotRead.LongSlotReadSetOrUnset;
import somns.interpreter.nodes.dispatch.CachedSlotRead.ObjectSlotRead;
import somns.interpreter.nodes.dispatch.CachedSlotRead.SlotAccess;
import somns.interpreter.nodes.dispatch.CachedSlotRead.UnwrittenSlotRead;
import somns.interpreter.nodes.dispatch.CachedSlotWrite.DoubleSlotWriteSet;
import somns.interpreter.nodes.dispatch.CachedSlotWrite.DoubleSlotWriteSetOrUnset;
import somns.interpreter.nodes.dispatch.CachedSlotWrite.LongSlotWriteSet;
import somns.interpreter.nodes.dispatch.CachedSlotWrite.LongSlotWriteSetOrUnset;
import somns.interpreter.nodes.dispatch.CachedSlotWrite.ObjectSlotWrite;
import somns.interpreter.nodes.dispatch.CachedSlotWrite.UnwrittenSlotWrite;
...
import somns.interpreter.objectstorage.StorageAccessor.AbstractPrimitiveAccessor;
